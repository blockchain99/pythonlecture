...
def is_valid_phone(input):
	...
	match = phone_regex.search(input)  #not match return None
	print(f"* returned : {match}") 
	if match: #Match obj returned -> True
		return True
	return False #not mached : return None -> false
